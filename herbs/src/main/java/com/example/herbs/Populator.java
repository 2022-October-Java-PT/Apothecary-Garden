...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Herbs alphaLipoicAcid = new Herbs("Alpha-Lipioic-Acid", "Alpha-lipoic acid is a chemical your body makes. It’s also found in foods such as red meat, spinach, broccoli, tomatoes, peas, Brussel sprouts, and rice bran.", "Alpha-lipoic acid is a fatty acid found naturally inside every cell of the human body. Its primary role is to convert blood sugar (glucose) into energy using oxygen. Many people use it to help with diabetes, nerve pain, weight loss, heart disease, and primary mitochondrial disorders.", "alphaLipoicAcid", "https://www.mskcc.org/cancer-care/integrative-medicine/herbs/alpha-lipoic-acid",null, alphaLipoicAcidIllnesses, alphaLipoicAcidSideEffects);
