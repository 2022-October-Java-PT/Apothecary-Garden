          ...
          {() => ( 
            <div className={style.disclaimer_popup}>
                <div className={style.disclaimer_content}>
                    ...
                    <section className={style.disclaimer_body}>
