        ...
        <div  className={style.container}>
            ...
            <div className={style.gallery}>
                ...
                <img  src={herbsForStore} alt='' />
                    <p> <h4>How to Store Herbs for Culinary & Medicinal Purposes</h4> Are you wondering how to store herbs so they last longer? Learn the best storage methods for fresh, dried, and powdered herbs.
            ...
            <div className={style.gallery}>
                <div className={style.box}>
                    ...
                    <p> <h4 >How to Store Dried Herbs</h4> Dried herbs can last anywhere from 2-4 years if stored properly depending upon the type of herb.First of all, make sure you are drying the herbs completely or they will mold and ruin all of the herbs. A dehydrator will make easy work of drying your homegrown herbs. Store herbs in air-tight jars or plastic bags in a cool, dark, and dry spot.Freezing works well for basil, chives, oregano, lemon balm, mint, or tarragon. Wash your fresh herbs and dry them on paper towels or with a salad spinner. Remove large woody stems and chop up the herbs and fill an ice cube tray with them. Top with olive oil and place them in the freezer. Once frozen, you can pop out the herb cubes and store them in a freezer bag.</p>
                </div>
            </div>
            ...
            <div className={style.gallery}>
                <div className={style.box}>
                    ...
                    <p> <h4>How to Store Powdered Herbs</h4> Tender herbs are easiest to store as powders. Once herbs are powdered, they will lose their freshness fairly quickly. Powdered herbs are best stored in glass jars wrapped in newspaper or some other opaque paper in the freezer or refrigerator. Chilled powdered herbs will last about 6 months.Powdered herbs left at room temperature should be kept in opaque glass jars. The shelf life of powdered herbs at room temperature is about 3 months.</p>
                </div>
            </div>
            ...
            <div className={style.gallery}>
                <div className={style.box}>
                    ...
                    <p> <h4>Storing Herbal Preparations</h4>  Once you've used your herbs in your own herbal remedies, whether it's a tea, tincture, or capsule, you still need to remember to store your preparation so that it will last.
